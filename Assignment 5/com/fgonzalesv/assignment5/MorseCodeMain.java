...
/**
 * An application to convert Morse Code into English. Uses methods of the MorseCodeConvert utility
 * class The user can type in a Morse Code String to have converted to English or select a file with
 * Morse Code to be converted to English
 * 
...
public class MorseCodeMain extends BorderPane {
  ...
  /**
   * Allow the user to select a file of morse code and then display the contents of the file, as
   * well as the conversion of the file into English
   */

 ...
 * 
 * It is intended for creation of LinkedTrees that do conversion using a LinkedTree
 * 
...
public interface LinkedConverterTreeInterface<T> {
  ...
  /**
   * Adds result to the correct position in the tree based on the code This method will call the
  ...
  /**
   * This method builds the LinkedConverterTree by inserting TreeNodes into their proper
   * locations
   * 
   */
  ...
  /**
   * The recursive method to put the contents of the linked converter tree in an ArrayList LNR
   * (Inorder)
   * 
